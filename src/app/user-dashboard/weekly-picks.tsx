...
export default function WeeklyPicks({ contestants, selectedEpisode, onSubmit }: WeeklyPicksProps) {
  ...
  const handleStarBakerClick = (contestantId: string) => {
    ...
    setStarBakerId(starBakerId === contestantId ? null : contestantId)
  }
  ...
  return (
    <div className="bg-green-50 p-6 rounded-lg mb-6">
      ...
      {/* Star Baker Section */}
      <div className="mb-6">
        <h4 className="text-md font-semibold text-green-800 mb-3">Star Baker Pick</h4>
          ...
          {contestants.map((contestant) => {
            ...
            return (
              <button
                ...
                disabled={isEliminated || !selectedEpisode.isActive}
